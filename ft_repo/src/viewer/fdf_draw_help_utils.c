...
/*   Updated: 2023/01/17 10:28:14 by dapereir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx_string_put(fdf->mlx, fdf->win, 24, HELP_OFFSET_Y + 20 * line, WHITE, label);
}

void	fdf_draw_value(t_fdf *fdf, int line, char *value, int color)
{
	mlx_string_put(fdf->mlx, fdf->win, HELP_VALUE_X, HELP_OFFSET_Y + 20 * line, color, value);
}
