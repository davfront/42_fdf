...
/*   Updated: 2022/12/17 14:40:57 by dapereir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	fdf_draw_frame(t_fdf *fdf)
{
	...
	p1 = fdf_new_pixel(20, 20, WHITE);
	p2 = fdf_new_pixel(200, 50, RED);
	p3 = fdf_new_pixel(200, 200, RED);
	fdf_draw_line(&fdf->img, p1, p2);
	fdf_draw_line(&fdf->img, p2, p3);
	fdf_draw_line(&fdf->img, p3, p1);
}
