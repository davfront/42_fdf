...
/*   Updated: 2022/12/18 10:04:16 by dapereir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	fdf_init_view(t_fdf *fdf)
{
	...
	fdf->h_scale = fmin(x_scale, y_scale);

	fdf->x0 = (WIN_WIDTH - (fdf->map.size_x - 1) * fdf->h_scale) / 2;
	fdf->y0 = (WIN_HEIGHT - (fdf->map.size_y - 1) * fdf->h_scale) / 2;
